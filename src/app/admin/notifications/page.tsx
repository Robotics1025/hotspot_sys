                                ...
                                {["all", "unread", "system", "important"].map((f) => (
                                    <button
                                        ...
                                        className={cn(
                                            ...
                                            filter === f ? "bg-[#111111] text-white shadow-xl shadow-black/20" : "text-gray-400 hover:text-gray-600"
                                        )}
                                    >
                                        {f}
                                    </button>
                        ...
                        <div className="space-y-4">
                            ...
                            {!isLoading && filtered.map((notif) => {
                                ...
                                return (
                                    ...
                                    >
                                        <div className={cn("w-14 h-14 rounded-2xl flex items-center justify-center shrink-0 shadow-inner", style.bg, style.color)}>
