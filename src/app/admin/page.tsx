...
// systemHealth is now computed inside the component from real statsData
            ...
            <div className="flex flex-col gap-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {[
                        ...
                        { name: "Total Revenue", value: isLoadingStats ? "..." : `UGX ${statsData?.totalRevenue.toLocaleString() || "0"}`, change: "+12.5%", icon: DollarSign, color: "bg-emerald-500" },
                        { name: "Active Nodes", value: isLoadingStats ? "..." : statsData?.totalNodes.toString() || "0", change: "+4", icon: Router, color: "bg-indigo-500" },
                        { name: "Platform Commission", value: isLoadingStats ? "..." : `UGX ${statsData?.totalCommission.toLocaleString() || "0"}`, change: "+UGX 842", icon: Activity, color: "bg-orange-500" },
                    ].map((stat) => (
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center justify-between p-4 bg-gray-50/50 rounded-2xl border border-transparent hover:border-gray-100 transition-all">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <p className="text-sm font-bold text-gray-900">RADIUS Server</p>
                                ...
                                <div className="flex items-center justify-between p-4 bg-gray-50/50 rounded-2xl border border-transparent hover:border-gray-100 transition-all">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <p className="text-sm font-bold text-gray-900">Active Clients</p>
                                            <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest">Platform partners</p>
                                        </div>
                                    </div>
                                    <div className="text-right">
                                        <div className="text-lg font-black text-gray-900">{isLoadingStats ? "…" : statsData?.totalClients ?? 0}</div>
                                ...
                                <div className="flex items-center justify-between p-4 bg-gray-50/50 rounded-2xl border border-transparent hover:border-gray-100 transition-all">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <p className="text-sm font-bold text-gray-900">Router Nodes</p>
                                            <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest">Deployed MikroTik NAS</p>
                                        </div>
                                    </div>
                                    <div className="text-right">
                                        <div className="text-lg font-black text-gray-900">{isLoadingStats ? "…" : statsData?.totalNodes ?? 0}</div>
                                        <div className="text-[8px] font-bold text-gray-400 uppercase">nodes</div>
                                    </div>
                                </div>
                                <div className="flex items-center justify-between p-4 bg-gray-50/50 rounded-2xl border border-transparent hover:border-gray-100 transition-all">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <p className="text-sm font-bold text-gray-900">Payment Gateway</p>
                                    ...
                                    <div className="p-6 bg-amber-50 rounded-[28px] border border-amber-100 flex gap-4">
                                        ...
                                        <div className="space-y-1">
                                            ...
                                            <p className="text-[10px] text-amber-800 leading-relaxed font-medium">
                                                Please provide these credentials to the client. They will be prompted to set a permanent password upon their first login. This account is automatically enrolled in the 10% commission model.
                                            </p>
                                        </div>
                                    </div>
