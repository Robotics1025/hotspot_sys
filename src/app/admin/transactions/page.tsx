                ...
                <div className="flex flex-col gap-8">
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-gray-500 text-sm mt-1">Monitor all financial transactions across the platform.</p>
                        </div>
                    ...
                    <div className="bg-white p-6 rounded-4xl border border-gray-100">
                        <div className="grid grid-cols-5 gap-4">
                            ...
                            <button
                                onClick={() => setFilters({ clientId: '', status: '', startDate: '', endDate: '' })}
                                    ...
                                    <table className="w-full">
                                        <thead>
                                            <tr className="border-b border-gray-100">
                                                ...
                                                <th className="text-left p-6 text-xs font-bold text-gray-500 uppercase tracking-wider">Voucher/Plan</th>
                                                <th className="text-left p-6 text-xs font-bold text-gray-500 uppercase tracking-wider">Amount</th>
                                                <th className="text-left p-6 text-xs font-bold text-gray-500 uppercase tracking-wider">Commission</th>
                                                <th className="text-left p-6 text-xs font-bold text-gray-500 uppercase tracking-wider">Payout</th>
                                                    ...
                                                    <tr key={transaction.id} className="hover:bg-gray-50/50 transition-colors">
                                                        ...
                                                        <td className="p-6">
                                                            {transaction.voucherCode ? (
                                                                <div>
                                                                    <p className="font-mono text-xs text-gray-900">{transaction.voucherCode}</p>
                                                                    <p className="text-xs text-gray-500">{transaction.planName}</p>
                                                                </div>
                                                            ) : (
                                                        ...
                                                        <td className="p-6">
                                                            <span className="font-medium text-orange-600">{formatCurrency(transaction.commission)}</span>
                                                        </td>
                                                        
                                                        <td className="p-6">
                                                            <span className="font-medium text-emerald-600">{formatCurrency(transaction.payout)}</span>
                                                        </td>
