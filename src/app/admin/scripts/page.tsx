...
export default function ScriptManagement() {
    ...
    const radiusIp = "142.250.180.14" // Mock central VPS IP
    const radiusSecret = "FastNet-Radius-2026"

    const [scriptContent, setScriptContent] = useState(`# FastNet Full System Setup Script (MikroTik RouterOS v6/v7)
# --------------------------------------------------------
# This script configures RADIUS, Hotspot, and Basic Security

/radius
add address=${radiusIp} secret=${radiusSecret} service=hotspot timeout=3000ms
/radius incoming
